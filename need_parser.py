...
print(text)
types = [u"主语", u"谓语", u"宾语", u"定语", u"状语", u"表语", u"补语"]
text = u"""
(S
  (subject He/PRP)
  (predicate reckons/VBZ)
  (object_clause
  (subject the/DT current/JJ account/NN deficit/NN)
  (predicate will/MD narrow/VB to/TO)
  (object only/RB 1.8/CD billion/CD)
  (adverbial_modifier in/IN September/NNP)
  ./.))
"""
tree_text = Tree.fromstring(text)

plot_model(tree_text, "hello.need")
